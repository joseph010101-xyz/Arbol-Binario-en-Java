 ...
 * @author flore
 */
public class frmArbolMV extends javax.swing.JFrame {
    ArbolM A;
    /**
     * Creates new form frmArbolMV
     */
    public frmArbolMV() {
        initComponents();
        A= new ArbolM();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmArbolMV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmArbolMV().setVisible(true);
            }
        });
    }
